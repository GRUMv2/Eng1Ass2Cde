...
public class StatsBox extends Entity {
    ...
    public void setStats(
        ...
        this.itemBoxes[1].setContent("Students: " + students);
        this.itemBoxes[2].setContent("Student Satisfaction: " + (Math.round(studentSatisfaction * 10000) / 100) + "%");
        this.itemBoxes[3].setContent("Staff: " + staff);
